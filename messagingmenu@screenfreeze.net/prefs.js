...
function createColorSettingWidget() {
	let hbox1 = new Gtk.Box({ orientation: Gtk.Orientation.HORIZONTAL, spacing: 12, margin_top: 5 });
...
function createNotificationSettingsWidget() {
	let vbox = new Gtk.Box({ orientation: Gtk.Orientation.VERTICAL, spacing: 12 });
	...
	let hbox2 = new Gtk.Box({ orientation: Gtk.Orientation.HORIZONTAL, spacing: 12, margin_top: 5 });
	...
	let hbox3 = new Gtk.Box({ orientation: Gtk.Orientation.HORIZONTAL, spacing: 12, margin_top: 5 });
...
function buildPrefsWidget() {
	let frame = new Gtk.Box({ orientation: Gtk.Orientation.VERTICAL, spacing: 12 });
	let vbox = new Gtk.Box({ orientation: Gtk.Orientation.VERTICAL, spacing: 12, margin_top: 10 });
